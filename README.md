...
Photo / Text / Voice
        │
        ▼
  BYOK provider API or Premium proxy  ──▶  JSON nutrition response
        │
        ▼
  User reviews & edits
        │
