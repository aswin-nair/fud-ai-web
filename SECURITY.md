...
- Network requests to AI and speech-to-text providers (`GeminiService`, `ChatService`, `SpeechService`). The managed-AI proxy client exists but fails closed before any network call.
