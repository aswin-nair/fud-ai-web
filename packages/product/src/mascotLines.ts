...
export const AMBIENT: Record<MascotState, string[]> = {
  ...
  sleepy: [
    'Nothing logged yet. One quick note is enough to keep the day.',
...
export const TAUNTS: Record<TauntPose, string[]> = {
  wave_at_user: [
    ...
    'Wave completed. I accept polite applause.',
    'That was my best hand. A strong performance.',
    'Greetings from this side of the screen.',
    'I am available for ceremonial hellos.',
  ],
  look_around: [
    ...
    'I am checking whether the corners moved.',
    'Everything appears to be exactly where it was.',
    'I patrol this screen with exceptional stillness.',
    'Just taking inventory of the pixels.',
  ],
  stretch: [
    ...
    'That loosened at least one imaginary joint.',
    'Professional stretching. Please take notes.',
    'I call that the full filing manoeuvre.',
    'Excellent. My posture has opinions again.',
  ],
  wander: [
    'I am taking the scenic route to nowhere.',
    'This corner needed an inspection.',
    'Patrol complete. No pixels escaped.',
    'I meant to come here. Obviously.',
    'New spot, same impeccable supervision.',
    'I am relocating for administrative reasons.',
    'The floor plan suggested a tiny adventure.',
    'I have changed offices. Please update the directory.',
    'A brief walk. My legs demanded representation.',
    'This seemed like a promising place to stand.',
    'I took the long way. It was still quite short.',
    'Position revised. Authority unchanged.',
  ],
  tiny_dance: [
    'That was choreography. Please be respectful.',
    'I call that the ledger shuffle.',
    'A tiny dance for a medium-sized mood.',
    'Rhythm detected. Dignity temporarily misplaced.',
    'My feet filed a motion.',
    'The music was internal and very exclusive.',
    'One flourish. Entirely necessary.',
    'That move is still awaiting approval.',
    'I danced. The paperwork can wait.',
    'Small steps, enormous stage presence.',
    'Please hold your applause until I finish wobbling.',
    'Performance complete. Reviews are unnecessary.',
  ],
  happy_hop: [
    'Up I go. A compelling use of gravity.',
    'That was a hop with excellent paperwork.',
    'I have briefly defeated the floor.',
    'Airborne. Technically.',
    'The ground and I needed a short break.',
    'A small leap for dumpling administration.',
    'I landed exactly where intended.',
    'Gravity remains operational.',
    'My feet requested a field trip.',
    'That counted as theatre. Probably.',
    'Height achieved. Modestly.',
    'I regret nothing about that landing.',
  ],
  ponder: [
    'I am considering a very small mystery.',
    'Thoughts are happening. Please remain calm.',
    'I nearly had an idea. It was magnificent.',
    'The screen has presented me with philosophy.',
    'I am thinking in exceptionally tidy circles.',
    'A question occurred. It declined to elaborate.',
    'Deep thought. Shallow paperwork.',
    'I have consulted the imaginary committee.',
    'One moment. My thoughts are alphabetising.',
    'The answer is probably in another tab.',
    'Contemplation complete. Findings inconclusive.',
    'I am giving this the full tiny think.',
  ],
  bow: [
    'I bow to the sheer drama of the moment.',
    'A formal acknowledgement. Very formal.',
    'Courtesy protocol complete.',
    'That was respect, with a little wobble.',
    'Please accept this professionally modest bow.',
    'I rehearsed that precisely once.',
    'Ceremony suits me.',
    'A small bow for a very select audience.',
    'Graceful enough. We move on.',
    'I remain humble and extremely noticeable.',
    'Diplomacy accomplished.',
    'The tally department sends its regards.',
  ],
}
